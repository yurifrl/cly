...
func (m Module) ID() string              { return "kafkax" }
func (m Module) Description() string     { return "Kafkax V3 support" }
func (m Module) Type() module.ModuleType { return module.MessagingModule }
