...
**YOU ARE IN: `cly/polecats/jasper/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/cly/` (rig root) or other directories
...
**Your mail address:** `cly/polecats/jasper`
**Your rig:** cly
**Your Witness:** `cly/witness`
...
| Ask Witness for help | `gt mail send cly/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`cly/witness`) when:
...
```bash
gt mail send cly/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
