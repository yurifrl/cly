...
func New(eventType string, useBeeep, useTerminalNotifier, useZellijStatus, useZellijNotify bool, icon string) Notifier {
	...
	if useTerminalNotifier {
		notifiers = append(notifiers, &TerminalNotifier{Icon: icon})
	}
